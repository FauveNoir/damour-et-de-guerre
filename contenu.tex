...
\addcontentsline{toc}{section}{Liminaire}
{
  ...
  L’amour est assurément une lutte, tandis que la guerre procède par la séduction. Sun Tzu ne dit-il pas si bien \enquote{Faites en sorte que vos prisonniers se retrouvent mieux chez vous qu’ils ne le seraient dans leur propre camp}, leçon dont s’instruirait fructueusement un amant ? La rime y répond.
...
\begin{prose}
  ...
  Ibn~Zamrak, toi qui instruisit son procès pour hérésie, que ne l’as-tu condamné, que ne l’as-tu exécuté et brulé ses restes  à la porte du Bûcher de Fez, il n’empêche que ses cendres flottaient dans les airs ce soir-là.
\end{prose}
...
\begin{verse}\quatrain
  ...
  \label{foot.vocaliseYeuxNuit} ne soyez  éblouis du feu\rhyme{eu}\\ \metric{10}
...
\begin{verse}\quatrain
  ...
  S’il n’avait appris à y nager, l’infâme. % 11
\end{verse}
...
\begin{verse}\quatrain\sizain
  ...
  À chaque arpège d’Astor Piazzolla.\index{Artistes!Piazzola@Astor \textsc{Piazzola}}\rhyme{ola}\index{Musique}\\ \metric{11}
...
\poemtitle{Le sentier pavé d’or}\index{Dune \emph{(œuvre de fiction)}}\index{Destin}
...
\endnote{Juan \textsc{Martin} interpréta le muwachaĥ andalou du \work{Lammā Bāda} dans son album \work{Musica Alhambra} paru en 1998.},\index{Artistes!Martin@Juan \textsc{Martin}}\index{Musique}\\ \metric{11}
...
\endnote{De l’arabe \textarabic{قاﻧﻮﻥ}. Instrument à cordes pincées, de la famille des cithares sur table.}\index{Musique!Kanoun}\label{foot.kanoun} nous font parvenir\rhyme{venir}\\ \metric{11}
  ...
  Qui des Almoravides aux Almohades,\rhyme{ade}\index{Histoire!4@Histoire arabo-musulmane}\\ \metric{11}
  ...
  Car la prise de  Moussa Ibn Noçaïr\rhyme[ere]{ère}\index{Personnages historiques!Moussa Ibn~Noçaïr}%
  \endnote{Wali et général du calife omeyyade. Personnalité de premier plan dans la conquête d’Al\,Andalous.}\\ \metric{11}
  ...
  Celles dont nous parvient encore l’empreinte. % 11
  ...
  \endnote{Pythie de Delphes dont l’oracle équivoque à Crésus lui annonçait qu’après la bataille qu’il devait mener, un grand empire allait s’effondrer. Après que Crésus ait mené sa bataille, un grand empire s’est effectivement effondré, le sien.}\\ \metric{11}
...
\begin{verse}\quatrain
  ...
  \incise{Tant qu’il n’est pas encore clos nul n’est battu}\index{Destin}\\ \metric{12}
  ...
  Mais saisi, il parachèvera la victoire.\rhyme{oir}\\ \metric{12}
  ...
  Ils sont nulle part ailleurs qu’accrochés au ciel\\ \metric{12}
...
\begin{verse}\quatrain
  ...
  Dégoûtante comme celles des bas quartiers,\rhyme{tier}\\ \metric{12}
  Princière comme les escortes de Gauthier% 12
  \endnote{Quartier réputé bourgeois de Casablanca.}.
\end{verse}
...
\begin{verse}\quatrain
  ...
  Rien n’est plus faux, voyons-le sur-le-champ.  % 10
  ...
  Il est vrai qu’il était tout aussi effronté\rhyme{fronté}\\ \metric{12}
...
%  Il se trouve qu’ayant lu ce poème, un ami me fit remarquer qu’à mon intuition poétique existe des fondements scientifiques, puisqu’une publication\endnote{\cite{Piff4086}} de l’université du Michigan corroborer la propension à l’arrogance des personnes à haut revenus à adopter des comportements manquant d’étiques.
  ...
  Mystère de l’intuition poétique qui s’étaye de fondements scientifiques ; il se trouve que peu de temps après avoir vécu cet épisode et rédigé le poème qui en parle, une publication\endnote{\cite{Piff4086}} de l’université du Michigan corrobora l’arrogance des personnes à hauts revenus et leur propension à adopter des comportements manquants d’éthiques et mortellement dangereux.
...
\begin{verse}\sizain
  ...
  Dont on longe de Cadix à Alicante,\\ \metric{11}\rhyme[alicante]
  ...
  Et morcelée en taïfas aliquantes\index{Histoire!4@Histoire arabo-musulmane},\\ \metric{11}
...
\poemtitle{De l’espoir du ressac}\index{Mer}\index{Destin}
\setIndexNameEntry[espoir du ressac]{De l’espoir du ressac}
%\setIndexNameEntry[]{}
\begin{verse}\haiku
  Devant l’océan,\\  % H
...
%\setIndexNameEntry[]{}
\begin{verse}\haiku
  En haut du houppier,\index{Architecture}\index{Islam}\\  \rhyme[ie]{ié}% H
...
%\begin{textblock*}{\textwidth+1in}(5.5cm,6.5cm) % sans le deuxième poème
...
\poemtitle{Gare à toi}
%\setIndexNameEntry[Gare a toi]{Gare à toi}
\begin{verse}\distique%
  \metric{8}%
  \rhyme[egare]{égare}%
...
\poemtitle[Ivresse à Kaffa]{Ivresse à Kaffa\endnote{Le titre du quatrain est dû au fait que la culture et la boisson du café virent le jour à Kaffa, en Éthiopie.}}%
...
\begin{verse}\quatrain
  Xayām% 9
  \endnote{L’apostrophe de Xayām, poète bachique iranien, lui rappelle son erreur et instaure une rivalité entre vin et café.},\index{Artistes!Xayam@\fallbackserif{Ȝ}omār Xayām}\label{foot.xayam} il y a grande méprise.\\  \rhyme{prise}% X
  Fille de la vigne que tu prises\\ \metric{9}
  N’est exquise face au chaud ou froid\index{Café!Rivalité Café-Alcool}\\ \metric{9}
  Café qui excite notre émoi.  % 9
\end{verse}
...
\endnote{Famille puissante d’Al\,Andalous.}\label{foot.Abencerage}\index{Al\,Andalous!Abencérage} ?\\  \rhyme{rage}%
  ...
  Aujourd’hui, de leurs fières fanfaronnades,\\ \metric{11}
  ...
  Nulle part ailleurs que dans leur triste mort.  % 11
...
\begin{verse}\quatrain
  ...
  Cours, va vers d’autres continents,\\ \rhyme{inan}\metric{8}
...
\begin{verse}\quatrain\sizain
  ...
  Dans ma sortie extravéhiculaire\\  %  10
...
\begin{verse}\haiku
  ...
  Et son son occit\endnote{Le verbe \autonym{occire} est défectif et ne se décline pas au présent de l’indicatif. Aussi la forme \autonym{occit} utilisée ici peut elle être vue comme néologique.}.
\end{verse}
...
\begin{verse}\quatrain\septain
  ...
  Que je ressortis pleine de jouvencelles.\metric{11}  % 
  ...
  \endnote{Vue talmudique des pharisiens qui, zélés dans leur expression de la pudeur, ferment les yeux ou se les cachent pour éviter de regarder les femmes. Au point qu’ils se cognent contre les murs et y saignent, selon la raillerie dont ils font l’objet.}, se trompent\\  \metric{11}
  ...
  \endnote{Dans le phénomène rare du double arc-en-ciel, une bande sombre entre les deux apparait, appelée d’après son découvreur \autonym{bande d’Alexandre}.}\\ \rhyme[andre]{[a\textbar{}e]ndre} % X
...
E&N&D&R&O&I&T\rlap{.}&~&~&~&O&R&D&U&R&E&S\rlap{,}&~&~&~&~&T&U&·&V&A&S&·&Y&·&O&P&P&O&S&E&R&·&T&E&S&·&D&I&A&B&L&E&R&I&E&S\rlap{.}&~&~&~&~&O&U&I&,&·&F&É&L&O&N&N&E\rlap{,}&~&\\
...
\begin{verse}\quatrain%
  ...
  Quand une ombre inconnue me rejoignît\index{Femmes}\\ \metric{10}
  ...
  De longs  cheveux\index{Femmes!Cheveux} noirs de brune torréfiée\index{Café!Café personnifié en femme},\\ \metric{12}
...
\begin{verse}\quatrain
  ...
  Et y trouves plein d’artifices et de ruse\\ \metric{12}
...
\begin{verse}\quatrain\neuvain
  ...
  \endnote{Ulysse d’Ithaque qui dans l’\work{Odyssée} demanda à son équipage de l’attacher au mat du navire pour ne point céder au chant des sirènes.}\label{foot.ithaquien}\\  % X
  ...
  C’est moi qui divague et perds la raison.\\ \metric{10}
...
\begin{prose}
  Peu avant de quitter Casablanca, j’étais tombé dans mon courrielleur sur une vieille épître que j’avais envoyé il y a dix ans à une certaine Lamiaë dont le souvenir emporta mon émotion, sans rien exagérer, jusqu’aux larmes. Il y a dix ans, je passais mon examen du baccalauréat (que j’ai d’ailleurs raté avec succès !), elle aussi et nous nous étions rencontrés à l’occasion de révisions dans un café.

  Nous passions plus de temps à discuter qu’à réviser d’ailleurs, et si souvent elle-même se levait de sa table pour venir s’assoir à la mienne, je la rappelais à l’ordre non pas pour m’en débarrasser mais parce qu’honnêtement je voulais que nous agissions de façon plus responsable et révisions à l’approche de l’examen. En fait, je me faisais même violence.
  ...
  Un an passa. Ayant rencontré un de ses anciens camarades de révision, à peine lui demandais-je \enquote{Je voulais te poser une question…}, qu’il sursauta \enquote{—\,Au sujet de Lamiaë ?}, et renchéri \enquote{Elle a fini par conclure qu’elle ne te plaisait pas, d’autant plus que tu es parti avec l’autre fille.}. Lecteur, ressens combien mes jambes se vidèrent à cet instant. Elles le demeurèrent si bien que depuis lors j’en suis encore cul-de-jatte.

  Sauf qu’il était trop tard. Ayant poursuivi ses études en Corée du Sud, les évènements m’avaient devancé et, bien inconscient devais-je être lorsque je tâchais malgré tout de rattraper le cours du temps  en écrivant à Lamiaë un ultime courriel que je concluais par la formule \enquote{Excuse le style quelque peu ampoulé mais s’il est vrai que j’ai assurément changé comme il doit en être de toi aussi, certaines choses demeurent éternelles.}.
\end{prose}
...
\poemtitle{Esprit retord}\index{Guerre!Ruse}\index{Epique@Épique}
\setIndexNameEntry[esprit retord]{Esprit retord}
%\setIndexNameEntry[]{}
\begin{verse}\sizain
  \rhyme{fuje}%
  \rhyme{lan}%
...
\begin{prose}
  Il me prit d’écouter le poème symphonique \work{L’Île des morts} de Sergueï \textsc{Rachmaninov}\index{Artistes!Rachmaninov@Sergueï \textsc{Rachmaninov}} tout en regardant le tableau éponyme d’Arnold \textsc{Böcklin}\index{Artistes!Bocklin@Arnold \textsc{Böcklin}} et, Ciel, que les deux se répondent. Il y a tant de profondeur émise par cette île en hémicycle magnifiquement sondée par la musique qui s’en inspire, que moi-même en fus  à mon tour inspiré autant qu’aspiré. Je dois même avouer qu’à partir de cet instant, un enthousiasme  irrépressible me poussa à chercher à la modéliser en 3D\index{Technique} ce qui me fit acquérir, quelque temps plus tard, un ordinateur assez puissant pour faire fonctionner Blender.
\end{prose}
...
\begin{verse}\quatrain\neuvain
  ...
  \endnote{Dans la mythologie bretonne, il s’agit de l’entité psychopompe, celle chargée du rôle de \enquote{passeur de morts}. Souvent représenté guidant une charrette où il charge les corps, il peut aussi les charger sur une barque.}, son confrère, à la mort ;\\  % X
...
\begin{verse}\quatrain
  ...
  La combinaison que ses formes cisèlent\\ \metric{11}
  ...
  Dont l’agilité sonne les tambours\\ \metric{10}\index{Guerre!Bellisonus}
...
\begin{prose}
  Quelques minutes auparavant, mon train fit halte à la gare de Salé\,—\,Tabriquet, tandis qu’un autre en fit autant sur le quai mitoyen, si bien que ma fenêtre s’aligna avec celle du train d’à côté.

  Il faisait encore nuit, et au carrefour des lumières et néons que diffractait le brouillard ambiant, au travers encore des deux vitres, comme au travers d’un miroir, m’apparut l’image \index{Photographie}photographique, ou la scène \index{Cinéma}cinématographique \incise{cette hésitation participant du mystère qui s’y loge} du passager se trouvant de l’autre côté. Image des plus fascinantes s’il en est. S’il n’y avait là ni haut-parleur ni enceinte, eh bien je l’entendais pourtant, je l’entendais cette musique lancinante, de la synthwave, c’était \work{Love on a real train} de Tangerine~Dream. Et qui m’aurait dit que je demeurais béat, la bouche ouverte, si ce n’est mon reflet sur la vitre devant moi ? 

%Cette hésitation participant même du mystère qui s’y loge.

  Il y’a dans ce face-à-face matière à faire une série de clichés photographiques où, à chaque arrêt de train, l’on photographierait les gens de l’autre côté.
...
Je songeais encore que, s’y prenant à l’avance, il faudrait à même le quai et avant de monter dans le train, repérer la place que l’on occupera pour en essuyer la fenêtre correspondance du côté extérieur. Ce afin que les clichés qui seront capturés depuis cette place ne pâtissent que des salissures de la fenêtre du second train.
  ...
  Du fait de l’aspect hirsute que me conférait alors ma barbe noire quelque trois mois après que j’eus cassé ma tondeuse, je me dis qu’il faudrait préparer des écriteaux à l’avance.
...
\begin{prose}
  J’écrivis les lignes qui suivent alors que j’étais attablé à un établissement de l’avenue Patrice Lumumba, en plein milieu d’une harassante journée de travail, tandis que le soleil caressait de quelques rayons dont la rigueur pouvait s’épargner pour peu que l’on s’en convainquît.
...
\begin{verse}\quatrain
  ...
  \rhyme[este]{èste}%
  \rhyme{iaire}%
  Ô puissant arôme subtil,\\ \metric{8}
  Sans lequel tout est futile,\\ \metric{7}
  Toi qui enchantes mes sens\\ \metric{7}
  Pareils à celle qui s’avance,\index{Café!Café personnifié en femme}  % 8
...
\AddToShipoutPictureFG*{%
  ...
  Traversant les rangées de table sur la cour,\\ \metric{12}
...
\begin{verse}\quatrain
  ...
  \rhyme{isse}%
  Te croyais-tu sur la redoute\index{Histoire!6@Modernité}\endnote{Allusion à la redoute Raïevski dans laquelle se trouvait le général \textsc{Clausewitz} d’après ses écrits lors de la bataille de la Moskova—Borodino.} si malin ?\\ \metric{12}  % 
  ...
  Mit à profit  l’immensité de sa métis\index{Guerre!Ruse}\endnote{Qualité relative à l’intelligence sociale attribuée à Ulysse. À rapprocher de la ruse.},\\   \metric{12}% 
  Et que tous les Achéens\endnote{Les Grecs, ennemis des Troyens.} périrent en lice ?\\   \metric{12}% 
...
\begin{verse}\quatrain
  ...
  Que vite je saisis dans l’instant subreptice\\   \metric{12}% 
  ...
  Partit la verbération qui fendit l’air\\   \metric{12}% 
  Mais c’est en moi que le bourdonnement s’ouït. \metric{12}
\end{verse}
...
\poemtitle{Le secret}\index{Epique@Épique}
\setIndexNameEntry[secret]{Le secret}
\begin{verse}\quatrain
  \rhyme{i}%
  \rhyme[e]{é}%
...
\begin{verse}\quatrain
  ...
  Ce qui eut lieu, c’est la guerre de Quatre.\metric{10}
\end{verse}
...
% Opposant des sourcils en un auvent.\metric{10}
  ...
  Se sont-ils adjoints pareilles corolles ?\metric{10}
\end{verse}
\end{textblock*}
...
\begin{verse}\quatrain
  ...
  Je l’admire  sans jamais la cueillir.\\  \metric{10}% 
  Et si l’étreinte,  la ferait périr\\  \metric{10}% 
  Gérard de Nerval\index{Artistes!Nerval@Gérard \textsc{de Nerval}}\index{Fleur!Cliché de \textsc{De Nerval}}, saura m’excuser.  \metric{10}% 
\end{verse}
...
\begin{verse}\dizain\huitain\sizain\neuvain\quintil\septain\quatrain
  ...
  Je bénis celui-là qui des transports\index{Amour}\\   \metric{10}% 
  ...
  Puissé-je me suffire d’un millénaire\\  \metric{11}% 
  ...
  Cache des galaxies au niqab.\\  \metric{9}% 
  ...
  Qui a pris les anneaux de saturne pour anse. \metric{12}
\end{verse}
...
\poemtitle{Nohimé}\index{Guerre!Guerrières}\index{Epique@Épique}
%\setIndexNameEntry[]{}
...
\poemtitle{La momie péruvienne}\index{Histoire!0@Préhistoire}
...
\begin{verse}\sizain\quatrain%
  ...
  Adressant un cri muet qui dessaisit,\\   \metric{11}% 
  ...
  Momie, nous écoutons ton cri insonore. \metric{11}
\end{verse}
...
\begin{verse}\quatrain%
  ...
  Qui sur la tour  cylindrique dévie.\endnote{En architecture militaire médiévale, les tours à base ronde sont connues pour être plus résistantes, notamment face aux tirs d’artillerie, que les tours à base carrée.}\label{foot.tourRonde} \metric{10}
...
\index{Guerre}\index{Histoire!7@Histoire contemporaine}\index{Epique@Épique}
\begin{verse}\quatrain\sizain
  \rhyme[ele]{èle}%
  \rhyme{mi}%
  \rhyme{rone}%
...
\begin{verse}\dizain
  ...
  Les commissures de ses lèvres vermeilles\\  \metric{11}% 
...
\begin{verse}\quatrain
  ...
  Que franchit la ligne phosphorescente\\  \metric{10}% 
...
\begin{verse}\distique
  ...
  Sur les traits des visages ouvriers, \metric{10}
...
\begin{verse}\quatrain
  ...
  Les gouttelettes typographiques\index{Ecriture@Écriture!Typographie}\index{Cinéma}\endnote{La \enquote{pluie de caractère} est un motif esthétique emprunté à \work{La Matrice}.}\\  \metric{9}% 
...
%  Une méthode pouvant elle même avoir d’autres méthodes. Dans certains langages de programmation, l’appel à une méthode sur un objet se fait en arrimant cette méthode à l’objet. Par exemple, sur l’objet \texttt{objet} s’applique la méthode \texttt{méthode} de la façon suivante : \texttt{objet.méthode}. Si une seconde méthode \texttt{méthode2} devait s’appliquer sur l’ensemble, celà prendrait la forme \texttt{objet.méthode.méthode2}.
  ...
  Telles des wagons qui roulent dans le soir\\  \metric{9}% 
...
\begin{prose}
  Avant \fallbackserif{Ȝ}īd al\,Aḋĥā, j’eus le plaisir de rencontrer une jeune femme que je vis d’abord, chose rare, sous son litham. Je dois admettre que ce vêtement censé repousser m’attira en réalité. Elle m’accorda même l’honneur de m’entretenir si bien que nous pûmes découvrir notre passion commune pour l’œuvre de fiction de Frank \textsc{Herbert}. Fait notable, lorsqu’elle retira son voile, je vis qu’elle avait des points de rousseur\index{Femmes!Rousseur} qui me rappelèrent le \enquote{goût de cannelle} qu’a l’épice récoltée sur Dune.
\end{prose}
...
\begin{prose}
  Et je composais alors sans doute mon première poème en arabe littéral dont je vous donne ici la traduction qui, fatalement, sacrifie la métrique autant que les rimes.
\end{prose}
...
\begin{longtable}{R{0.3\textwidth} L{0.65\textwidth}}
  ...
  \noalign{%
    ...
    \index{Dune \emph{(œuvre de fiction)}}\index{Epique@Épique}\distique
  }
...
\begin{verse}\sizain
  ...
  Avant que ne nous ait séparés le désert.\metric{12}
\end{verse}
...
\begin{verse}\quatrain
  ...
  Les trirèmes britons des légions romaines\index{Histoire!3@Rome antique}\\  \metric{12}
...
\begin{verse}\quatrain
  ...
  Qui vogue sur l’océan vermeil.  \metric{9}
...
Car le sentier d’or est pavé des miettes du pain qu’ont rompues les justes.
  ...
  \AtPageLowerLeft{%
    \begin{tikzpicture}[remember picture]
      ...
      \node (other)  (current bounding box.south east) at ([shift={(30:7)}]nile) {
        ...
        \null\hspace{1.5cm}Nicopolis\index{Histoire!2@Rome—Grèce—Égypte}\index{Guerre!Bataille}\endnote{Ville bâtie par Octave à la suite de sa victoire contre Marc-Antoine et Cléopâtre.}\index{Egypte@Égypte!Cléopâtre}, cité de la victoire\\  % 
...
\begin{verse}%
  ...
  \rhyme{ome}%
  \rhyme[ole]{olé}%
  Tel le mets épousseté de cinnamome,\\
  Avec la rousseur, parti toute arôme.\\
  Et elle me laissa inconsolé\\
  Car la cannelle s’en était envolée.\\
\end{verse}
...
\begin{verse}%
  ...
  telle l’aurore, où vint y luire\\  % 
...
\begin{verse}
  ...
  Beethoven\index{Artistes!Beethoven@Ludwig \textsc{van Beethoven}}, lui, veut pourtant nous conter les siens.\\  % 
...
\begin{verse}
  ...
  Quand seulement une décade s’est écoulée,\\  % 
  ...
  Si avec Ismaël\endnote{La fête de l’Immolation célèbre la ligature de l’abrahamide. Si la tradition judéo-chrétienne identifie l’abrahamide dans le personnage d’Isaac,  la tradition islamique \incise{sans que le Coran ne l’explicite} y voit Ismaël.}, Abraham eût sacrifié jusqu’à Shouah%
  \endnote{Shouah est l’un des huit enfants d’Abraham, probablement le cadet.} \\
  Et qu’aussi souvent Gabriel l’en eût empêché sur le Moriah%
  \endnote{Le mont Moriah est l’endroit où l’ange Gabriel commanda à Abraham de procéder à la ligature.}.

  Des volutes qui montent se hume le parfum,\\
...
\begin{prose}
  ...
  Devant son irritation que j’ai malgré tout tenu  à modérer, elle a insisté pour que sa vindicte transparaisse au travers de ladite lettre.
...
spécialement tendue moi-même afin de ne pas encombrer et salir les étendoirs aux dépens des autres co-propriétaires, par respect pour tous ; et me voilà remerciée de la belle manière pour mes égards. Il y a là de l’injustice, Monsieur le syndic de copropriété, et grande est mon affliction.

S’en suit qu’il ne s’agit pas d’un menu larcin improvisé mais d’une préméditation clairement planifiée qui n’a pu s’établir qu’en deux temps au minimum. Car, i)\,il a bien fallu que l’auteur repère dans un premier temps l’objet de son méfait, et ii)\,qu’il revienne en suite doté d’un récipient suffisamment grand afin de dérober le bien indu en pleine connaissance de cause. Et dans son zèle, il a même emporté la cordelette verte. C’est dire s’il y a là une pernicieuse surenchère dans l’ingénierie du mal. C’en est caricatural puisqu’à l’injustice, il a adjoint le ridicule.
...
Le tort n’a pas été commis qu’à mon détriment mais, avec lui, l’auteur du vol a emporté, outre la viande et la cordelette verte, le crédit que nous nous accordions mutuellement entre copropriétaires. En agissant dans l’ombre, il a jeté le discrédit sur chacun d’entre nous.
...
\begin{prose}
  ...
  Était-ce à cause de la menace de faire fonctionner la caméra ? Le ton particulièrement irrité ? Le style pompeux ? Le détail des évènements ? L’envolée lyrique compte au sacrilège ?

  Eh bien, pour ma part, je crois qu’il ne s’agit de rien de tout cela et que le gris typographique et la grosse lettrine ont suffi à intimider le contrevenant sans même qu’il n’ait lu la lettre.
\end{prose}
...
\begin{verse}%
  ...
  Mais tu n’es qu’une épidémie, un mal.\\  % 
...
\begin{verse}%
  ...
  La main à la bouche qui bâille,\\  % 
  Elle ajuste ses lunettes\\  % 
  Et reprends son travail.
\end{verse}
...
\begin{prose}
  ...
  M’ayant contacté, je transcrivis l’engouement qui transparut d’elle.
\end{prose}
...
\begin{verse}%
  ...
  Quand l’amour fût dévolu au Troyen Pâris\endnote{Héros du cycle troyen qui, devant trancher entre l’amour, la puissance militaire, et l’autorité, prit le parti du premier au détriment des autres.}.

  Car, comme une oasis surgissant du désert\index{Islam!Coran},\\  % 
  Le Kawtar\endnote{Rivière paradisiaque mentionnée dans le Coran. Elle est censée ne contenir que des bienfaits.} prit les traits d’un amour aux yeux pers\index{Femmes!Yeux}\\  % 
...
\begin{prose}
  Je rencontrai alors mademoiselle F***** dont l’une des particularités qui me séduisirent immédiatement est que la pointe de son sourcil gauche est encochée. Il y a tant de mystères dans ce sourcil encoché que j’en fus intrigué.
...
\poemtitle[L’exhortation de Ȝumār par le sourcil fendu]{L’exhortation de \fallbackserif{\textbf{Ȝ}}umār\endnote{On rapporte que l’apôtre Ȝumār a annoncé \enquote{Apprenez à vos enfants l’archerie, la natation, et l’équitation}. Or, chacune des trois premières strophes de ce poème s’attache à l’une de ces disciplines en constituant alors un triptyque.} par le sourcil fendu}%
...
\begin{verse}%
  ...
  La chevauchant, Zulfixār\endnote{Épée à pointe double que Mahomet a trouvée dans le butin de la bataille de Badr.} en main,\index{Guerre!Epee@Épée}\\
  Elle m’entraîne au galop jusqu’au lointain.

  Mystère du défaut qui se fit victoire.\\
  Surlignant de l’encre l’iris \xenism{barroco}\endnote{Du portugais \xenism{barroco}, désigne en joaillerie une pierre belle parce qu’irrégulière.}\label{foot.barroco}\\
...
\begin{prose}
  Le poème qui vient est écrit en maghrebi, le dialecte marocain, \caution{langue qui malgré son apparente ressemblance avec l’arabe littéral du fait de quantité de racines communes, tiendrait davantage du carthaginois}.

  Il aborde dans un style proche du genre musical chaabi \incise{que je honnis pourtant} des thèmes enracinés dans un tropisme marocain et sans doute même passéiste. Mais dont les préoccupations animent à s’y méprendre les contemporains.

  La traduction qui en est donnée, qu’après réflexions je voulus davantage littérale quoique s’accommodant de quelques adaptations plus littéraires, trahis forcément les rimes et la métrique.
...
\begin{longtable}{R{0.3\textwidth} L{0.65\textwidth}}
  ...
  \textarabic{و فبالي صوت الضقايق،}        &       L’esprit des percussions de cuivre imbibé\index{Musique},   \bigskip \\ 
  ...
  \textarabic{الا مشا حتا زلق نفيض.}        &       Vient à glisser, je fonds.   \bigskip \\ 
  ...
  \textarabic{لي حتا امّ الربيع ميقطع؟}     &       Celui qui ne traverse le fleuve d’Um~al~Rabiȝ\endnote{Fleuve usuellement graphié \autonym{Oum Errabiâ} prenant sa source aux environs de Khénifra  et débouchant vers les environs d’Azemmour dans l’océan Atlantique. De ce fait, un voyageur qui irait de Kénitra à Eljadida, le traverserait.}\,?   \bigskip \\ 
  ...
  \textarabic{نضلّ نقلّب على القافية.}       &       Je poursuivrais la recherche des rimes.\index{Propos réflexif}   \\  % 
\end{longtable}
...
\begin{verse}%
  ...
  Avec l’RJ45\endnote{Le nom usuel quoique fautif d’RJ45 désigne les câbles 8P8C servant à connecter des machines à un réseau Ethernet et plus particulièrement à l’Internet.} pour fil\index{Technique}\\  % 
...
%tes bras substituer\\  % 
  ...
  Pleure à mes côtés mon désarroi.
  ...
  Toi qui ailleurs diriges le mât,\index{Mer!Navigation}\\  % 
  En fait de tout louvoyant discours,\\  % 
  Si tu dubites de mon amour,\index{Amour}\\  % 
  Regarde ma vulve et tu sauras\index{Femmes}.
\end{verse}
...
\begin{prose}
  Me trouvant non loin du musée de la banque centrale du Maroc, je me dis qu’il valait encore mieux y noyer ma peine. Grand bien me prit car alors \incise{joi} bien loin de m’en douter, j’y trouvais des éléments prélevés sur le site archéologique d’Aghmat, des parties de la maison d’Al\,Mutamid ibn~Abbad\index{Personnages historiques!Al\,Mutamid ibn~Abbad} qui commandita à Lissān~al\,Ḋḋīne ibn~al\,Xatīb\index{Al\,Andalous!Lissān~al\,Ḋḋīn ibn~al\,Xatīb} des poèmes à graver sur ses murs. Mais plus bouleversant encore, un manuscrit que je crus comprendre autographe de Lissān~al\,Ḋḋīne ! Fort heureusement, le masque que je portais du fait de l’épidémie m’épargna le ridicule d’exposer aux gens les larmes qui coulèrent le long de mes joues. Je me suis même retenu de m’assoir par terre tant mes jambes s’étaient vidées de leur tonus.

  Je dois toutefois être honnête, je n’ai pas pris la peine de vérifier que les manuscrits étaient bien autographes comme j’ai cru le comprendre ; ou plus exactement j’ai soigneusement évité de m’en assurer, préférant me complaire dans l’idée qu’ils l’étaient.
\end{prose}
...
\begin{verse}%
  ...
  M’est aussi odieux qu’Aghmat.\endnote{Al\,Mutamid Ibn~Abbad  qui a été roi de Séville, fut destitué par les Almoravides pour être exilé à Aghmat où il mourut.}

  Que vienne me voir le Double-Vizir\endnote{Allusion à Lissān~al\,Ḋḋīne ibn~al\,Xatīb, savant qui fut par deux fois ministre aux cours nasride et mérinide, ce qui lui valut le surnom de \enquote{celui aux deux vizirat} \textarabic{ذي الوزارتين}. Lors de son exil à Aghmat, Al\,Mutamid Ibn~Abbad fit appel à ses services de poète pour rédiger des vers qui furent calligraphiés sur les murs de sa maison.}\\  % 
...
\begin{prose}
  Si heureux de l’avoir composé, j’ouvris mon journal et tout le monde me vit esquisser un improbable sourire de satisfaction en lisant un article intitulé \work{Armes françaises pour dictature exemplaire}\endnote{\cite{diplo813-armesFrancaisesPourDictatureModele}}.
\end{prose}
...
\begin{prose}
  Je passais avec Inès une de ces journées dont on parlera encore dans les siècles des siècles. Ne vous ai-je jamais parlé d’elle ? Nul besoin, l’ensemble de l’ouvrage est teinté de son empreinte.
...
\begin{verse}%
  ...
  C’est alors ma cité que j’ai vue\\  % 
...
\begin{verse}%
  ...
  \metric{12}%
  \rhyme[e]{é}%
  Comme un soldat tombé au sol car surfléché\\  % 
  Qui scrute le champ d’honneur avant d’abdiquer\index{Guerre!Bataille}\\  % 
  Et sur lequel pleuvent les flèches acérées,\\  % 
  Je suis assailli de ses  baisers enflammés.\index{Amour}
\end{verse}

\poemtitle[Le nay]{Le nay\endnote{Flûte à l’origine perse d’où elle tire son nom signifiant \autonym{roseau}, mais aussi turc et arabe intervenant en général dans le répertoire de la musique savante.}}\index{Musique}%
...
\poemtitle{Sac de la bibliothèque d’Alexandrie}\index{Histoire!1@Antiquité}
%\setIndexNameEntry[]{}
\begin{verse}%
  \quatrain%
  \metric{11}%
  ...
  La bibliothèque dégarnie de livres\\  % 
...
\begin{verse}%
  ...
  Les rideaux tombent, il est neuf heures.\index{Nuit}\\  % 
  Angle Mohamed~\textsc{v}—Diouri,\\  % 
  Viens y en ramenant des sushis\\  % 
  ...
  Khadija, appelle-moi ce soir.\\  % 
  Crois-moi, \enquote{Starship} me jalousera\index{Astronomie}\\  % 
  Car j’atterrirais où que tu sois\\  % 
  Mieux que Mars ce sera pour te voir.
\end{verse}

\begin{prose}
  Fut donnée à Kénitra une projection de \work{La Femme écrite}\index{Cinéma} à laquelle était présent le réalisateur même, M.\,Lahcen \textsc{Zinoun}\index{Artistes!Zinoun@Lahcen \textsc{Zinoun}} pour une séance d’entretiens. Ce film me démangeait. Il m’a semblé qu’une parade nuptiale berbère prenait les accents de la habanera \work{Carmen} de \textsc{Bizet}\index{Artistes!Bizet@Georges \textsc{Bizet}}. À un autre moment, j’ai cru voir une allusion à \work{Body Double} de Brian \textsc{De Palma}\index{Artistes!Palma@Brian \textsc{De~Palma}}, quand certains plans ne me faisaient pas carrément penser à la série des odalisques d’\textsc{Ingres}\index{Artistes!Ingres@Jean·Auguste·Do\-minique \textsc{Ingres}} tant elles semblaient en être décalquées.
...
\begin{verse}%
  ...
  Ter, mer, ciel, espace, et jusqu’au cyberespace\\  % 
  ...
  Un champ certes sont les corps des femmes\\  % 
...
\poemtitle{Nakano Takeko}\index{Guerre!Généraux historiques}\index{Japon}\index{Guerre!Guerrières}\index{Epique@Épique}
%\setIndexNameEntry[]{}
\begin{verse}%
  \sizain%
  \metric{6}%
...
\poemtitle{Café turc}\index{Café}\index{Epique@Épique}
...
\begin{verse}%
  ...
  \rhyme{ieu}%
  \rhyme{or}%
  Constantinople\index{Histoire!4@Histoire arabo-musulmane} prise par l’ivoire,\\  % 
  ...
  Que d’autres Talas\index{Histoire!5@Histoire de Chine}\endnote{Bataille de la rivière Talas ayant opposé le califat abbasside à la dynastie Tang pour le contrôle de la Transoxiane et au cours de laquelle les mercenaires turques Karlouks alliés des Chinois font volte-face au profit des Abassides ancrant depuis lors les peuples turcs dans le monde musulman.} aient encore lieu,\\  % 
  \incise{Cent Talas} pour qu’autant de fois encore\\  % 
  Soit nôtre ce café délicieux,\\  % 
  Et le papier\endnote{Il est probable que les captifs Chinois faits par les Abbassides au cours de la bataille de Talas aient introduit dans le monde musulman les techniques de fabrication du papier, donnant par conséquent le coup d’envoi à l’âge d’or arabo-musulman.} où j’écris ces mots d’or.\index{Ecriture@Écriture}\index{Propos réflexif}
\end{verse}

\poemtitle{La cour des Lions}\index{Al\,Andalous!Alhambra}
\setIndexNameEntry[cour des Lions]{La cour des Lions}
\begin{verse}%
  \quatrain%
  \metric{9}%
  \rhyme{aine}%
...
\begin{verse}%
  ...
  \rhyme{u}%
  \rhyme[esse]{èsse}%
  Ses paroles, je les bus comme la ciguë\\  % 
...
\begin{verse}%
  ...
  Entre les montagnes et les bêtes fauves\\  % 
  ...
  Je lui susurrais à l’oreille en chuintant :\\  % 
  \enquote{Y a-t-il plus heureux que nous en cet instant ?}

  Mais qu’avait-elle besoin de répondre, elle,\\  % 
  Quand les fières étoiles\index{Astronomie!Etoiles@Étoiles} peuplant le ciel\\  % 
...
\begin{verse}%
  ...
  \emph{Votre sang abreuve les fontaines de l’Alhambra\endnote{Allusion à la légende de l’extermination des Abencérages dans un bain de sang dont on rapporte : \enquote{La fontaine d’apparat ne laissait plus couler de l’eau, mais leur sang…}.}}\\  % 
  ...
  Damno vestram nefas rixam cum Ziridis\index{Histoire!4@Histoire arabo-musulmane}   \\  % 
  ...
  \emph{Si votre père fut sans doute cordonnier\endnote{\autonym{Abencérage} de l’arabe \textarabic{بنو سراج}, voulant dire \enquote{fils de cordonnier}.},}\\  % 
...
\begin{verse}%
  ...
  En y peignant la douce couleur chair des femmes\index{Femmes}\\ %
  Celle qui, à l’arrivée du matin, se fane.
\end{verse}
...
\begin{verse}%
  ...
  C’est un crépuscule écarlate céleste\\ %
  Qui pare son visage et ses gestes lestes.
\end{verse}
...
\begin{verse}%
  ...
  Et s’allume dans nos yeux vermeils\\  % 
...
\poemtitle[Amour sur Arrakis]{Amour sur Arrakis\endnotemark[\getrefnumber{foot.DuneArrakis}]}\index{Dune \emph{(œuvre de fiction)}}
...
\begin{verse}%
  ...
  Ô sayyadina\endnote{Sorte de prêtresse des Fremen qui guide l’orgie tau.}, hâte-toi\\  % 
  ...
  L’âme affûtée par le vent du désert,\\  % 
...
\begin{prose}
D’amblais, il me sembla voir une proximité phonétique entre les mots latins d’\autonym{enfant}, \autonym{livre}, et \autonym{liberté}. Serait-ce sans doute parce que les livres libèrent les enfants ? Ce qui se dit :
\end{prose}
...
\begin{verse}%
  ...
  Suspends-en promptement de l’assaillant l’haleine.\\  % 
...
\begin{verse}%
  ...
  Livrant l’ennemi aux sinuosités de la guerre.\index{Guerre!Guerrières}
\end{verse}
...
\poemtitle{Alpha Lupi}
\setIndexNameEntry[a Lupi]{Alpha Lupi}
\begin{verse}%
  \quatrain%
  \metric{11}%
  \rhyme{passe}%
  ...
  Les longs cheveux\index{Femmes!Cheveux} noirs de la Beta Cephei\endnote{Les étoiles variables de type Beta Cephei, ou par métonymie les Beta Cephei constituent une catégorie d’étoiles dont fait partie l’alpha Lupi.}\\  % 
  ...
  Il n’est désormais plus Férmi\endnote{Jeu de mots avec le paradoxe de Fermi. Du nom du prix Nobel de physique qui postula une série d’observations et émit des hypothèses au sujet de l’existence de civilisations extraterrestres.} d’en douter.
  ...
  Je vis mes tripes dans les vases canopes.\index{Egypte@Égypte}

  Mugissant, glatissant, rugissant, priant\endnote{Chaque cri représente l’un des \enquote{quatre vivants}. Le taureau pour le mugissement, l’aigle pour le glatissement, le lion pour le rugissement, et l’ange pour la prière.}\\  % 
...
\begin{prose}
  C’est en sa compagnie à elle, Alpha du Loup, que s’affermit mon goût pour la synthwave qui s’était auparavant manifesté. Que n’ai-je appris d’elle, au risque de paraphraser les poèmes où j’en parle déjà.
...
\begin{figure}[h]
  ...
  \captionsetup{labelformat=empty}
  \caption[Idéotexte de \autonym{piano}]{}
\end{figure}

\begin{prose}
  Je ne devrais plus rien ajouter d’autre la concernant, à elle qui composa pour moi de jolies chansons sur son piano, et qui aurait encore probablement fait des symphonies si je n’avais pas fait le con. Mais autant qu’un ivrogne qui prendrait un dernier verre pour la route, je prendrais moi aussi un dernier vers.
\end{prose}
...
\begin{floatpoem}
  ...
  \begin{center}
    ...
    \sbox4{\marginnote{\endnote{Anubis est le dieu de la mythologie égyptienne vers lequel se rendent les âmes des défunts après leur inhumation, et notamment vers lequel se rendent les âmes des pharaons après que leur tombeau ait été scellé dans la pyramide.}}}
    \tabbedCenterstack{
      ~&~&~&~&~&~&~&~&~&~&~&Ô&~&~&~&~&~&~&~&~&~&~&~\\  % 
      ~&~&~&~&~&~&~&~&~&~&P&I&C&~&~&~&~&~&~&~&~&~&~\\  % 
      ~&~&~&~&~&~&~&~&~&S&A&C&R&É&~&~&~&~&~&~&~&~&~\\  % 
...
\begin{prose}
  Que dire encore, sinon que je me souviens que lorsque F***** m’emmena sur les remparts de la cité portugaise d’Eljadida, elle m’entraina jusqu’à un mirador où notre intimité ne fut rompue que par un rayon de lumière.
\end{prose}
...
\begin{verse}%
  ...
  Il y en aura quand j’aurai cessé de vivre.\\  % 
...
\begin{verse}%
  ...
  Alourdies des gouttelettes qui abreuvent le Nil\index{Egypte@Égypte!Nil}\\  % 
