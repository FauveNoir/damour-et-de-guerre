...
\begin{verse}\quatrain\sizain
  ...
  Et portée par la voix de Juan \textsc{Martin}\index{Artistes!Juan \textsc{Martin}}\index{Musique}%
...
\begin{verse}\quatrain
  ...
  \textsc{Clausewitz}, je  dis à ta destination :\\ \metric{12}  % 
...
{\em\small
  ...
  Aussi, quelque peuvent être les implications de la relativité générale, sache lecteur, que tu tiens entre les mains le premier TARDIS.


  \paragraph{}
  Là dessus, mon vœu pour toi lecteur est que ces biens modestes écrits en agissent sur toi comme il en a été pour moi, ce qui se résume plus que jamais dans la formule de salutation des Égyptiens antiques :
  \begin{tabbing}
