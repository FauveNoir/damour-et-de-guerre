...
\addcontentsline{toc}{section}{Liminaire}
{
  ...
  \hspace{-1.7cm}\includegraphics[width=0.36\textwidth]{lettrine-A-diborgo-grand.pdf}}\addcontentsline{lof}{figure}{Lettrine \autonym{A} aux divines proportions d’après l’alphabet de \textsc{di~Borgo} accompagné de lierre, lyre, casque corinthien, et dague}%
\hspace{-0.2cm}{\color{rouge}\em\textsc{l’origine de ce diwan,}} oh oui, il y’avait certes toute l’inspiration qui est y est à l’œuvre, de ces petits riens du quotidien que l’on ne sait précieux que lorsqu’on les perds. Instants fugaces si bien observés par Bashō\index{Artistes!Bashō} qui n’ont d’autre défauts que de nous en laisser insatiables comme l’a relevé Lissān~al-Ḋḋīn, et ce parcequ’ils sont insaisissables. Or c’est malgré tout \incise{non pas en vain, espéré-je} qu’à travers la poésie je comptais en capter quelque instantané comme l’aurait fait \fallbackserif{Ȝ}omār Xayām ou sans doute même… Louis \textsc{Daguerre}\index{Photographie}.
...
\begin{verse}\quatrain
  ...
  Mais toi, café son acolyte, lui ouvre les volets\rhyme{é}\\ \metric{15}
...
\begin{verse}\haiku
  Sur sillon dorsal,\\  % H
  Fuie la nappe de café.\\  % H
  Des cheveux châtain.
\end{verse}

\poemtitle{Du cheveux sur la manche}\index{Café}\index{Femmes!Cheveux}
\begin{verse}\haiku
...
\begin{prose}
  ...
  Ibn~Zamrak, toi qui instruisit son procès pour hérésie, que ne l’as-tu condamné, que ne l’as-tu exécuté et brulé ses restes  à la porte Calcinée de Fez, il n’empêche que ses cendres flottent dans les airs ce soir.
\end{prose}
...
\begin{verse}\quatrain
  Les larmes que tu extirpas de mon âme\rhyme{âme}\\ \metric{11}
  Ne suffirent pas à calmer le brasier\rhyme{é}\index{Feu}.\\ \metric{11}
...
\poemtitle{Parole}
\begin{verse}\quatrain
  Un seul mot sucré d’elle\rhyme{el}\index{Amour}\\ \metric{6}
...
\begin{verse}\quatrain\sizain
  ...
  À chaque arpège d’Astor Piazzolla.\index{Artistes!Astor Piazzola}\rhyme{ola}\index{Musique}\\ \metric{11}
  Mais, sur ses joues, les perles qui s’éclaboussent,\\ \metric{11}
  Indélébiles, sont des larmes de verre\rhyme{ère}\\ \metric{11}
  Qui pleuvent pareilles au pianola\\ \metric{11}
  Aussi irrépressibles et régulières. % 11

  L’on ne peut les essuyer ni les briser\rhyme{risé}\\ \metric{11}
  Mais leur point faible en est le \rhyme{ament}filament%
  ...
  Solide et imprenable de l’extérieur\rhyme{térieur}\\ \metric{12}
...
\begin{verse}\haikuII
  ...
  Et je prend congé du monde. % H7
\end{verse}


\poemtitle{Le sentier pavé d’or}\index{Dune}\index{Destin}
\begin{verse}\sizain
  Tous les rayons du soleil\index{Astronomie!Soleil} se recueillent\rhyme{cueille}\\ \metric{10}
...
\begin{verse}\quatrain\sizain
  ...
  Et portée par la voix de Juan Martin\index{Artistes!Juan Martin}\index{Musique}%
  \endnote{Juan Martin interpréta le muwachaĥ andalous du \work{Lammā Bāda} dans son album \work{Musica Alhambra} parrut en 1998.},\\ \metric{11}
  ...
  Car la prise de  Moussa Ibn Noçaïr\rhyme{aire}\index{Personnages historiques!Moussa Ibn~Noçaïr}%
  ...
  Plus que jamais prévaut le dit d’Alarcos\rhyme{coce}%
...
\begin{verse}\distique
  Ce n’était peut-être qu’un baiser\rhyme{é}\index{Amour}\\ \metric{9}
...
\begin{verse}\haiku
  Quand elle s’assied\rhyme{é}\index{Femmes}\\  % H
...
\begin{verse}\quatrain
  Vous croyez que c’était un cavalier\rhyme{lié}\\ \metric{10}
  Mais c’est un vif éclair qui est passé.\rhyme{assé}\\ \metric{10}
  ...
  Un chevalier qui galope à bride abattue\rhyme{battu}\\ \metric{12}
  Vers un château dont le pont-levis se relève,\rhyme{lève}\\ \metric{12}
  \incise{Tant qu’il n’est pas encore clôt nul n’est battu}\index{Destin}\\ \metric{12}
  Vers la muraille en approche, il saisit son glaive\index{Ecriture@Écriture!Épigraphie}.  % 12

  Il n’y a qu’une infime chance, un interstice\rhyme{ice}\\ \metric{12}
  ...
  Car la physique qui hésite et se flagelle,\rhyme{elle}\\ \metric{12}
  Entre la gravité et mouvement, chancelle\\ \metric{12}
  Et a tranché pour les deux en simultané.  % 12

  Dans leur ascension et leur chute si frêles\rhyme{iel}\\ \metric{12}
...
\begin{verse}\sizain
  ...
  Nos embrassades crépusculaires\rhyme{ère}\index{Amour}\\ \metric{9}
...
\begin{verse}\quatrain
  ...
  Chauve-souris dans une chambre anéchoïque\rhyme{ique}\\ \metric{12}
...
\begin{verse}\quatrain
  ...
  Il y a là du mérite et tant de civisme\rhyme{ivisme}\\ \metric{12}
  Qu’il ne s’agit assurément pas d’arrivisme.  % 12

  Ayant agis ainsi avec un prolétaire,\rhyme{tère}\\ \metric{12}
...
\begin{verse}\tercet
  Tracez puissantes nefs\index{Mer!Navigation}\\ \rhyme{ef}\metric{6}
  Des sillons sur les sept mers\\ \rhyme{ère}\metric{7}
  Qui mènent aux champs verts.  % 6

  Oui, tracez derechef\\ \metric{6}
  Loin vers les terres  nouvelles\\ \rhyme{èl}\metric{7}
...
\begin{verse}\distique
  ...
  \endnote{Distique anglophone transcrit en runique pouvant se retranscrire en alphabet latin comme suit :
    ...
    \end{longtable}}\\  \rhyme{ear}\metric{5}
...
\begin{verse}\sizain
  Telle une femme fière qui ne se dompte\index{Femmes}\\ \rhyme{\lbrack{}o|ante\rbrack{}}\metric{11}
  Dont on longe de Cadix à Alicante,\\ \metric{11}
  Les imprenables formes et les côtes\index{Mer!Navigation},\\ \rhyme{côte}\metric{10}
...
\begin{verse}\quatrain
  Quand avec mon OPA je passe à l’attaque,\\ \rhyme{aque}\metric{12}
...
\begin{verse}\distique
  Ô Ulysse, pourquoi avais-tu quitté ton Ithaque,\\ \rhyme{aque}\metric{14}
...
\begin{verse}\quatrain
  ...
  Vous n’hériterez de la terre de vos pères\\ \rhyme{ère}\metric{12}
  Que la largeur de la tombe où l’on vous enterre.  % 12
\end{verse}

\poemtitle{De la mosquée volante}
\begin{verse}\haiku
  Dessus du houpier,\index{Architecture}\index{Islam}\\  \rhyme{ier}% H
...
\begin{floatpoem}
  \poemtitle{Le chien}\calligramme
  \vspace{-1cm}
...
\begin{verse}\quatrain
  ...
  Même le trône qu’ils croient édifier,\\ \rhyme{é}\metric{11}
...
\begin{verse}\quatrain
  ...
  Sur ton arcade sourcilière,\\ \rhyme{ière}\metric{8}
...
\begin{verse}\quatrain
  ...
  Frappent tout droit et indisposent la belle\index{Femmes}\\ \rhyme{el}\metric{11}
...
\begin{verse}\quatrain\sizain
  ...
  Aide mon astronef à se diriger.\\ \rhyme{ger}\metric{11}
  ...
  Opérateur, lorsque je flotte en l’air,\\ \rhyme{aire}\metric{10}
  Déploie le canadarm%
  ...
  Soient toutes gravées en hiéroglyphes\index{Ecriture@Écriture!Hiéroglyphes},\\  \rhyme{if}%  10
  Lorsqu’aux commandes je suis émotif,\\  %  10
  Lorsque je déclenche l’ignition\index{Feu}.  %  10

  Opérateur, suivant tes conseils adroits,\\ \rhyme{droit}\metric{11}
...
\poemtitle{L’indice}
\begin{verse}\distique
  Les yeux\index{Femmes!Yeux} des adolescentes disent\index{Femmes}\\ \rhyme{sent}\metric{9}
...
\begin{verse}\quatrain\septain
  ...
  \index{Mythologie}\endnote{Personnage du folklore celtique dont la cachette se trouve à l’endroit où \enquote{l’arc-en-ciel touche terre}.},\\ \rhyme{ône}\metric{12}  % X
  J’ai posé mon guéridon près de l’arc-en-ciel\\ \rhyme{el}\metric{12}
  ...
  Et les Pharisiens dont provient le blâme\index{Talmud}\\ \rhyme{âme}\metric{11}
  Qui, mord à la bouche et œillères aux tempes,\\ \rhyme{ampe}\metric{11}
  ...
  \endnote{Dans le phénomène râre du double arc-en-ciel, une bande sombre entre les deux apparait, appelée d’après son découvreur \autonym{bande d’Alexandre}.}\\  % X
...
%\cofeDm{0.1}{0.1}{0}{0cm}{0cm} % TODO coffe
  ...
  %\cofeDm{0.2}{0.5}{5}{-7cm}{0cm} % TODO coffe
  Et le serveur diffuse ton encens.\\ \metric{10}
...
\begin{verse}\quatrain
  Te croyais-tu sur la redoute\index{Histoire!Modernité}\endnote{Allusion à la redoute Raïevski dans laquelle se trouvait le général Clausewitz d’après ses écrits lors de la bataille de la Moskova—Borodino.} si malin ?\\ \metric{12}  % 
...
\begin{verse}\quatrain
  ...
  Ce qui eu lieux, c’est la guerre de Quatre.\metric{10}
\end{verse}
...
\begin{verse}\quatrain
  ...
  Ce petit triangle de chaire blanche\\  \metric{10}% 
  ...
  Où la pupille qui pointe en téton,\\  \metric{10}% 
  Aréolée de khôl. Quand il se baisse,\\  \metric{10}% 
...
\begin{verse}\quatrain
  M’enlisant dans le lieux commun\\\index{Propos réflexif}  \metric{8}% 
  ...
  Gérard de Nerval\index{Artistes!Gérard de Nerval}\index{Fleur!Cliché de \textsc{De Nerval}}, saura m’excuser.  \metric{10}% 
\end{verse}
...
%
  ...
  Toute emplie de l’âme qui me plut.\\  \metric{9}% 
  Étanche mon inclination.\\  \metric{9}% 
  Car quand gronde l’incendie ardent\\  \metric{9}% 
  Celui qui reste grand sous le vent,\\  \metric{9}% 
  Celui qui est de l’éloignement,\\  \metric{9}% 
  Il brûle et puis s’accroît jusqu’aux nues.\metric{9}
...
\begin{verse}\quatrain
  ...
  Reste donc le chêne-liège doux de bois\\  \metric{11}% 
  Qui, quoique par cette saison démasclé,\\  \metric{11}% 
  Est la  cible dont le tissage parfait\\  \metric{11}% 
...
\begin{longtable}{R{0.3\textwidth} L{0.65\textwidth}}
  ...
  \textarabic{﴿من زارها زارني﴾.}    & \enquote{Qui l’aura visité m’a visité}\endnote{La planète Dune est un lieux de pèlerinage.}.\\  % 
  \\  % 
  \textarabic{بفضل متعتك،}      & De la jouissance qui émane de toi,\\  % 
  \textarabic{ازرقت اعيني.}    & Mes yeux bleuirent\endnote{L’atmosphère de Dune est saturée d’une substance appelée épice qui a de nombreux effets métaboliques sur le corps humain dont celui de rendre les yeux bleus ce que l’on nome le regard de l’\autonym{ibad}.}\label{foot.regardibad}.\\  % 
  \\  % 
...
\begin{verse}\sizain
  ...
  Avant que ne nous ai séparé le désert.\metric{12}
\end{verse}
...
\begin{verse}\quatrain
  ...
  Sous les râles des humains et les bêlements.  \metric{12}
...
\poemtitle{Éxhortation au partage selon les deux espèces}
\lettrine[lines=3]{V}{ous romprez votre pain} avec plus pauvre que vous et verserez de votre outre dans la sienne afin que vous mangiez du même pain et buviez de la même eau que lui.
...
\addcontentsline{toc}{subsection}{Bataille d’Actium}
      \renewcommand\currentpoemtitle{Bataille d’Actium}%
...
\addcontentsline{toc}{subsection}{Place de la Concorde}
      \renewcommand\currentpoemtitle{Place de la Concorde}%
\index{Epique@Épique}%
\metric{6}%
\quatrain
...
\renewcommand\currentpoemtitle{Larmichettes}%
    \metric{4}
    \quintil
...
\begin{verse}
  \quatrain%
  \metric{12}%
  Tandis que Mozart\index{Artistes!Mozart} fait oublier nos tourments,\\  % 
  Beethoven\index{Artistes!Bethoven}, lui, veut pourtant nous conter les siens.\\  % 
...
\begin{verse}
  ...
  \endnote{La fête de l’Immolation célèbre la ligature de l’abrahamide. Abraham ayant eu huit enfants, si l’épisode de la ligature devait avoir lieux aussi souvent qu’il ne lui en resta, il y’aurait eu alors sept autres ligatures, correspondant potentiellement à autant de commémorations.}
...
\begin{longtable}{R{0.3\textwidth} L{0.65\textwidth}}
  ...
  \textarabic{حاضي الگمرا لا تطير.}         &       Je veille à ce que la lune ne croule\index{Astronomie}.   \\  % 
  \\  % 
  \textarabic{ضال فايق،}                   &       Demeurant éveillé\index{Insomnie},   \\  % 
  \textarabic{و فبالي صوت الضقايق،}        &       L’esprit des percutions de cuivre imbibé\index{Musique},   \\  % 
  \\  % 
  \textarabic{راني خايف}                   &       Je crains   \\  % 
  \textarabic{لَي جي يقجني السّالف.}         &       Que la longue\index{Femmes!Cheveux} natte vienne m’étrangler.   \\  % 
  \\  % 
  ...
  \textarabic{و متخصر حتا شوفى فيا.}       &       Elle ne m’accorde pas un seul regard.\index{Femmes!Yeux}   \\  % 
  \\  % 
  ...
  \textarabic{فگلستها الماّحا.}             &       À l’avènement de son assise raffinée.   \\  % 
  \\  % 
...
\begin{verse}%
  ...
  Ceux qui sont gravés loin sur les hauteurs,\index{Ecriture@Écriture!Épigraphie}\\  % 
...
\poemtitle{L’étudiante}\index{Femmes}
\begin{verse}%
  \sizain%
  \metric{11}%
...
\begin{verse}%
  ...
  Pourtant, rien n’eut lieux ce jour là.\\  % 
...
\begin{verse}%
  ...
  Délaissant l’archer pour un pizzicato\index{Musique}\endnote{Technique de violon consistant à pincer les cordes des doigts au lieux d’utiliser l’archer.},\\  % 
...
%\begin{textblock*}{6cm}(7cm,9cm) 
%  \begin{figure}[h] % TODO
%    \centering
%    \includegraphics[width=\textwidth]{hofra.pdf}
%    \captionsetup{labelformat=empty}
%    \caption[Idéotexte du \autonym{trou} (\textarabic{حفره})]{}
%  \end{figure}
%\end{textblock*}
