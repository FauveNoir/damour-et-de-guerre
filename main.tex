...
\makeindex
\makeindex[name=rhymes,title=Index des rimes]
...
\newcommand{\rhyme}[1]
{%
  \index[rhymes]{#1@-#1!\emph{\currentpoemtitle}}%
}
...
{
  \index[metric]{#1@#2!\emph{\currentpoemtitle}}
}
...
{
  \index[strophy]{#1@#2!\emph{\currentpoemtitle}}
}
