...
%  \markboth{Carte géopolitique du début du \textsc{xviii}\ieme siècle}{}
  \newgeometry{left=0mm,right=0mm,top=0cm,bottom=0cm}
    ...
    \begin{figure}[p]% will be the left-side figure
        \adjincludegraphics[width=\textwidth,trim={0 0 {.5\width} 0},clip]{contreplat-0.pdf}
    \end{figure}
    \begin{figure}[p]% will be the right-side figure
      \pagecolor{white}
        \adjincludegraphics[width=\textwidth,trim={{.5\width} 0 0  0},clip]{contreplat-0.pdf}
    \end{figure}
  \restoregeometry
  \pagecolor{white}
...
\clearpage\pagecolor{creme}\pagestyle{empty}\newpage\pagestyle{empty} 
