...
\thispagestyle{empty}
 ...
 % \newpage
  ...
  \indexprologue{\small Sont indiqués, pour chaque thème, seulement les numéros de pages des poèmes ou sections prosaïques où celui-ci est abordé.}
  \printindex

  %\addcontentsline{toc}{section}{Index des rimes}
  \indexprologue{\small Sont indiqués, pour chaque rime, seulement les numéros de pages des poèmes qui les contiennent.

  \paragraph{}
  Afin de parer la multiplicité des orthographes possibles pour un même son, les rimes sont transcrites ici de la façon phonétique la plus intuitive possible.
  }
  \printindex[rhymes]

  %\addcontentsline{toc}{section}{Index des vers}
  \indexprologue{\small Sont indiqués, pour chaque type de vers, les poèmes contenant au moins un vers du dit type ainsi que leurs numéros de page.}
  \printindex[metric]

  %\addcontentsline{toc}{section}{Index des strophes}
  \indexprologue{\small Sont indiqués, pour chaque type de strophe, les poèmes contenant au moins une strophe de ce ces types ainsi que leurs numéros de page.}
  \printindex[strophy]
